...
namespace CleaveFramework.Factory
{
    ...
    public static class Factory
    {
        ...
        static public MonoBehaviour AddComponent<T>(string componentName, GameObject go)
        {
            ...
            var component = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/CleaveFramework/Factory/Factory.cs (59,29)", componentName) as MonoBehaviour;
        ...
        static public MonoBehaviour AddComponent<T>(GameObject go)
        {
            ...
            var component = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/CleaveFramework/Factory/Factory.cs (89,29)", typeof(T).Name) as MonoBehaviour;
            component = Injector.PerformInjections(component);
            component = (MonoBehaviour)InvokeDefaultConstructor<T>(component);
            return component;
        }
        ...
        static public MonoBehaviour AddComponent<T>(GameObject go, Constructor constructor)
        {
            ...
            var component = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/CleaveFramework/Factory/Factory.cs (121,29)", typeof(T).Name) as MonoBehaviour;
            component = Injector.PerformInjections(component);
            ...
            where T: class
        {
            ...
            var component = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/CleaveFramework/Factory/Factory.cs (153,29)", typeof(T).Name) as MonoBehaviour;
            component = Injector.PerformInjections(component);
            component = (MonoBehaviour)InvokeDefaultConstructor<T>(component);
            ...
            where T : class
        {
            ...
            var component = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/CleaveFramework/Factory/Factory.cs (188,29)", typeof(T).Name) as MonoBehaviour;
            component = Injector.PerformInjections(component);
            component = (MonoBehaviour)InvokeConstructor<T>(component, constructor);
            PushSingleton<T>(data, component);
            return component;
            ...
            where T : class
        {
            ...
            var component = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/CleaveFramework/Factory/Factory.cs (225,29)", typeof(T).Name) as MonoBehaviour;
            component = Injector.PerformInjections(component);
            component = (MonoBehaviour)InvokeConstructor<T>(component, constructor);
            ...
            where T : class
        {
            ...
            var component = UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/CleaveFramework/Factory/Factory.cs (260,29)", typeof(T).Name) as MonoBehaviour;
            component = Injector.PerformInjections(component);
            component = (MonoBehaviour)InvokeDefaultConstructor<T>(component);
            PushTransient<T>(data, name, component);
            return component;
