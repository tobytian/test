...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		{
			AgentMeta.TotalSignature = 2835104560;
			...
			// TeatA
			meta = new AgentMeta(1722747049);
			AgentMeta._AgentMetas_[3248109217] = meta;
			meta.RegisterMethod(1045109914, new CAgentStaticMethodVoid<string>(delegate(string param0) { TeatA.LogMessage(param0); }));
			meta.RegisterMethod(2384779256, new CAgentMethodVoid(delegate(Agent self) { ((TeatA)self).TestL(); }));
			meta.RegisterMethod(2521019022, new CMethod_behaviac_Agent_VectorAdd());
			meta.RegisterMethod(2306090221, new CMethod_behaviac_Agent_VectorClear());
			meta.RegisterMethod(3483755530, new CMethod_behaviac_Agent_VectorContains());
			meta.RegisterMethod(505785840, new CMethod_behaviac_Agent_VectorLength());
			...
			AgentMeta.Register<TeatA>("TeatA");
			return true;
		}
		...
		public override bool UnLoad()
		{
			...
			AgentMeta.UnRegister<TeatA>("TeatA");
			return true;
		}
	}
}
